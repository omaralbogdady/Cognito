...
function App() {
  ...
  const sortedAndFilteredTasks = useMemo(() => {
    ...
    return filtered.sort((a, b) => {
      ...
      if (sortBy === 'createdAt') {
        ...
        const dateA = a.dueDate ? a.dueDate.getTime() : (sortOrder === 'asc' ? Infinity : 0);
        const dateB = b.dueDate ? b.dueDate.getTime() : (sortOrder === 'asc' ? Infinity : 0);
  ...
  }, [tasks, activeTab, searchQuery, sortBy, sortOrder]);
        ...
        >
          ...
          <div className="p-6 space-y-6 w-full lg:w-80">
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1 flex items-center bg-surface dark:bg-surface-muted-dark rounded-2xl px-4 py-3.5 border border-border dark:border-border-dark shadow-sm transition-all focus-within:ring-4 focus-within:ring-primary-brand/10 focus-within:border-primary-brand group">
              ...
              <div className="relative">
                <button 
                  ...
                  className={cn(
                    "p-3 rounded-2xl border transition-all h-[48px] w-[48px] flex items-center justify-center shrink-0",
                    isSortMenuOpen 
                  ...
                  {isSortMenuOpen && (
                    <>
                      ...
                      <motion.div 
                        ...
                        className="absolute right-0 top-full mt-2 w-48 bg-surface dark:bg-surface-muted-dark rounded-2xl shadow-xl border border-border dark:border-border-dark z-50 overflow-hidden"
                      >
                        <div className="p-2 space-y-1">
                          <p className="px-3 py-2 text-[10px] font-black text-text-muted uppercase tracking-widest leading-none mb-1">Sort By</p>
                          {[
                            ...
                            <button
                              ...
                              onClick={() => {
                                if (sortBy === option.value) {
                                  ...
                                  setSortOrder(option.value === 'dueDate' ? 'asc' : 'desc');
                                }
                                setIsSortMenuOpen(false);
                              }}
                              className={cn(
                                "w-full text-left px-3 py-2.5 rounded-xl text-xs font-bold transition-colors flex items-center justify-between",
                                sortBy === option.value 
                                  ? "bg-primary/10 text-primary-brand" 
                                  : "text-text-main dark:text-text-main-dark hover:bg-surface-muted dark:hover:bg-border-dark"
                              )}
                            >
